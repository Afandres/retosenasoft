...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <button type="button" class="btn btn-primary btn-sm rounded-pill shadow" id="detectObjectsButton">Detectar Objetos</button>
        ...
        $(document).ready(function () {
            ...
            $("#send_request_button").click(function () {
                ...
                function predictFromUrl(imageUrl) {
                    ...
                    const predictionUrl = "https://southcentralus.api.cognitive.microsoft.com/customvision/v3.0/Prediction/6937ad05-be4d-4d72-97c2-34f194ae1118/classify/iterations/quialification_Senasoft/url";
                ...
                function predictFromLocalImage(imageFile) {
                    // URL y clave de predicción de Custom Vision
                    const predictionUrl = "https://southcentralus.api.cognitive.microsoft.com/customvision/v3.0/Prediction/6937ad05-be4d-4d72-97c2-34f194ae1118/classify/iterations/quialification_Senasoft/image";
                    const predictionKey = "f396d854b020421c86efedb94f63c183";
           ...
           // Agregar evento al botón "Detectar Objetos"
                ...
                function predictFromUrl2(imageUrl) {
                    // URL y clave de predicción de Custom Vision
                    const predictionUrl = "https://southcentralus.api.cognitive.microsoft.com/customvision/v3.0/Prediction/4a21c679-b6f1-4337-81c7-b9de39203f07/detect/iterations/Detection_Challenge/url";
                    const predictionKey = "f396d854b020421c86efedb94f63c183";
